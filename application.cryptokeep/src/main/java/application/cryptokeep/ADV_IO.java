...
import java.io.*;
public class ADV_IO implements Serializable{
	
	String path, data;
	
	//Serialize the Object:
	
	public void storeObject(passObject obj, File filename) throws IOException {
	...
	//STOP complaining about the lack of documentation.
